...
ALTER SEQUENCE public.satelites_sat_id_seq OWNED BY public.satelites.sat_id;
...
--
-- Name: satelites sat_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.satelites ALTER COLUMN sat_id SET DEFAULT nextval('public.satelites_sat_id_seq'::regclass);
...
INSERT INTO public.galaxy VALUES (1, 'Milky Way', true);
INSERT INTO public.galaxy VALUES (2, 'Andromeda', NULL);
INSERT INTO public.galaxy VALUES (3, 'Segue 1', NULL);
...
INSERT INTO public.star VALUES (1, 'alpha', 'blue-white', 2);
INSERT INTO public.star VALUES (2, 'beta', 'yellow', 2);
INSERT INTO public.star VALUES (3, 'sun', 'yellow', 1);
...
SELECT pg_catalog.setval('public.satelites_sat_id_seq', 1, false);
...
ALTER TABLE ONLY public.satelites
    ADD CONSTRAINT satelites_pkey PRIMARY KEY (sat_id);
